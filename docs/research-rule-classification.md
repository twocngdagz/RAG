...
C6 | Rubric trend ±5, recovery gate `s0 >= 70`, 3 most recent scores | `ComposeStudySession::weakItemPriorityProfiles` | `initial_policy` | **Implemented; OPEN** in requirements §15 — the code decided "yes, AI scores influence weak-item priority" |
C7 | `DECLINE_SHORT_LEASH_HOURS = 12`, `RECOVERY_DUE_DAY_BONUS = 1` | `UpdateLearnerItemStatesAfterSession` | `initial_policy` | **Implemented, undocumented** |
